...
function _parallelUpload(offsetIndex, // @arg Any - Number
                         chunks,      // @arg Any - StringArray
                         callback){   // @arg Any - Function - callback(err:Error|null, urls:URLStringArray):void
                                      // @ret void
//{@dev
...
//}@dev
    ...
    chunks["forEach"](function(chunk, i){
        new URLShortener()["shorten"]("http://"+(offsetIndex+i)+".zip/#"+chunk, function(err, shortUrl){
...
//}@dev
    ...
    chunkUrls["forEach"](function(chunkUrl, i){
        new URLShortener()["expand"](chunkUrl, function(err, chunk){
            if(!!err) return task["done"](err);
